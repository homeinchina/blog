...
2. 下载：[二进制文件](https://github.com/cjyzwg/cjblog/releases/tag/1.0.0),如果下载速度慢，点击[这里](https://gitee.com/cjyzwg/cjblog/releases/1.0.0)
3. cd cjblog，点击二进制文件
